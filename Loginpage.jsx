      ...
      .then(res =>{
        if(res.data.Status ==="success"){
          ...
          if(res.data.data[0].roles === "admin"){
            ...
            const id = res.data.id
            navigate(`/Owner_page/${id}`)
            // navigate(`/Traderpage`) 
          } 
          else if(res.data.data[0].roles === "manager"){   
            const id = res.data.id
...
<div className='container min-vh-100  d-flex justify-content-center align-items-center' >
  <div className='row'>
    <div className='col '>
<div className="card" style={{background:'#E5C7BC'}}>
  <div className='p-5'>
  ...
  <div className='text-center card-title'>
    Let's start with our company for create future 
...
<div className='text-center'>
<Link to={'/machine_loginpage'}> <button className='btn btn-outline-secondary' >Login With Machine Account </button></Link>
</div>
</div>
</div>
<div>
