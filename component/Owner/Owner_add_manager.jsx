...
function Owner_add_manager() {
    ...
    var live = getid.branchname

    console.log(live, 'me')

    var like = getid.username
    console.log(like, 'fdsa') 
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`http://localhost:5001/api/owner_add_manager/${id}`, addtrader)
            .then(res => {
                        ...
                        <div className='row '>
                            ...
                            <div className='col-sm-4'>
                                <div className='card text-dark bg-light border-danger mb-3 p-3'>
                                    ...
                                    <div className='formgroup py-2'>
                                        <label htmlFor="name"> branchname   {errors.branchname && <span className='text-danger' >{errors.branchname}</span>} </label>
                                        <input className="form-control " onChange={e => setaddtrader({ ...addtrader, branchname: e.target.value })} name='branchname' id='name' type="text" />
                                    </div>
                            ...
                            <div className='col-sm-4'>
                                ...
                                <div className='formgroup py-2'>
                                        ...
                                        <select name='gender' className="form-control" onChange={e => setaddtrader({ ...addtrader, gender: e.target.value })}>
                                            {
                            ...
                            <div className='col-sm-4'>
                                ...
                                <div className='formgroup py-2'>
                                    ...
                                    <div className='formgroup py-2'>
                                        ...
                                        <select name='city' className='form-control py-2' onChange={e => setaddtrader({ ...addtrader, city: e.target.value })}>
                                            {
                                                choice.map((opts, index) =>
